...
import com.s16.widget.cropper.CropOverlayView;
import com.s16.widget.cropper.Edge;
import com.s16.widget.cropper.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    /**
     * Sets the Process Listener of the CropImageView.
     * 
     * @param processListener the listener object
     */
    ...
    /**
     * Gets a Bitmap of the CropImageView.
     */
    ...
    /**
     * Gets the aspect ratio is fixed or not.
     */
    public boolean getFixedAspectRatio() {
    	return mCropOverlayView.getFixedAspectRatio();
    }
    	...
    	new AsyncTask<Bitmap, Void, Bitmap>() {
			...
			protected void onPreExecute() {
				if (mOnProcessListener != null) {
					mOnProcessListener.onProcessStart();
				}
		    }
			...
			protected void onPostExecute(Bitmap result) {
				...
				if (mOnProcessListener != null) {
					mOnProcessListener.onProcessComplete();
				}
		    }
