...
import com.s16.widget.cropper.Handle;
import com.s16.widget.cropper.AspectRatioUtil;
import com.s16.widget.cropper.HandleUtil;
import com.s16.widget.cropper.PaintUtil;
...
public class CropOverlayView extends View {
	...
	protected static final String TAG = CropOverlayView.class.getSimpleName();
    ...
    public void setAspectRatioX(int aspectRatioX)
    {
        if (aspectRatioX <= 0)
            ...
            mTargetAspectRatio = AspectRatioUtil.calculateAspectRatio(mAspectRatioX, mAspectRatioY);
